            ...
            <form method="POST" action="{{ route('posts.store') }}">
                ...
                <div class="flex items center justify-between mt-4">
                    ...
                    <a href="{{ route('posts.index') }}"
                        class="inline-flex items-center px-1 pt-1 border-b-2 border-indigo-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">Back</a>
                </div>
            </form>
        </div>
    </div>
